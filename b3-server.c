...
void *handle_quiz(void *arg)
{
	while (1)
	{
		if (next == 2 && soal == 1)
		{
			// send_message_to_all("Soal Selanjutnya....\n");
			sleep(1);
			quiz2();
			next = 0;
		}
		...
		// 	viewscoreboard();
		// 	send_message_to_all("Soal Selanjutnya....\n");
		// 	send_message_to_all("Semua kemungkinan pasti ada!!\n");
		// 	sleep(2);
		// 	quiz3();
		// 	next = 0;
		// }
		...
		// 	viewscoreboard();
		// 	send_message_to_all("Soal Selanjutnya....\n");
		// 	send_message_to_all("Tetap Semangat dan Pantang Menyerah!!\n");
		// 	sleep(2);
		// 	quiz4();
		// 	next = 0;
		// }
		// if(next == 2 && soal == 4){
		// 	viewscoreboard();
		// 	send_message_to_all("Soal Terakhir\n");
		// 	send_message_to_all("Berjuanglah!! Bangsaku!! Harapan itu masih ada!!\n");
		// 	sleep(1);
		// 	quiz5();
		// 	next = 0;
		// }
